...
public class MainFrame extends JFrame 
{
            ...
            public void run() 
			{
                try 
				{
                    ...
                    while (!Thread.interrupted()) 
					{
                        ...
                        final String address = ((InetSocketAddress) socket.getRemoteSocketAddress()).getAddress().getHostAddress();// Выделяем IP-адрес
    ...
    private void sendMessage() 
	{
        try 
		{
            final String senderName = textFieldFrom.getText();  // Получаем необходимые параметры
